...
export async function PATCH(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  if (body.contenido_generado) payload.contenido_generado = body.contenido_generado
  if (body.estado) payload.estado = body.estado
  if (body.nombre) payload.nombre = body.nombre
