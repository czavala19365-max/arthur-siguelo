...
import { getTituloById, actualizarEstadoTitulo } from '@/lib/supabase'
import { descargarEsquela } from '@/lib/scraper'

/**
 * GET /api/descargar-esquela?id={tituloId}&index={n}
 *
...
export async function GET(request: NextRequest) {
  ...
  if (!titulo.area_registral) {
    // Intentar obtener area_registral consultando SUNARP
